      ...
      <div v-if="pasoActual === 1">
        ...
        <form id="formPaso1" @submit.prevent="validarPaso1">
          <div class="row g-3 mb-3">
            ...
            <div class="col">
              <input type="text" id="numeroDocumento" class="form-control" placeholder="Número de documento" v-model="formulario.numeroDocumento" />
            </div>
          </div>

          <div class="row g-3 mb-3">
            <div class="col">
              <input type="text" id="primerNombre" class="form-control" placeholder="Primer nombre" v-model="formulario.primerNombre" />
            </div>
            <div class="col">
          ...
          <div class="row g-3 mb-3">
            <div class="col">
              <input type="text" id="primerApellido" class="form-control" placeholder="Primer apellido" v-model="formulario.primerApellido" />
            </div>
            <div class="col">
              <input type="text" class="form-control" placeholder="Segundo apellido" v-model="formulario.segundoApellido" />
            </div>
          </div>

          <div class="row g-3 mb-3">
            <div class="col">
              <input type="tel" id="telefono" class="form-control" placeholder="Teléfono" v-model="formulario.telefono" />
            </div>
            <div class="col">
              <input type="text" id="direccion" class="form-control" placeholder="Dirección" v-model="formulario.direccion" />
            </div>
          </div>
          ...
          <div class="row g-3 mb-3">
            ...
            <div class="col">
              <input type="text" id="ciudad" class="form-control" placeholder="Ciudad de residencia" v-model="formulario.ciudad" />
            </div>
          </div>

          <div class="row g-3 mb-3">
            <div class="col">
              <input type="text" id="nacionalidad" class="form-control" placeholder="Nacionalidad" v-model="formulario.pais" />
            </div>
            <div class="col">
              <input type="text" id="lugarNacimiento" class="form-control" placeholder="Lugar de nacimiento" v-model="formulario.lugarNacimiento" />
            </div>
          </div>
        ...
        <form id="formPaso2" @submit.prevent="validarPaso2">
          ...
          <div class="mb-3">
            ...
            <div class="input-group">
              <input :type="mostrarPass ? 'text' : 'password'" id="contrasena" class="form-control" v-model="formulario.contrasena" placeholder="Ingresa una contraseña" />
          ...
          <div class="mb-3">
            ...
            <div class="input-group">
              <input :type="mostrarConfirm ? 'text' : 'password'" id="confirmarContrasena" class="form-control" v-model="formulario.confirmarContrasena" placeholder="Confirmar contraseña"/>
          ...
          <button type="button" class="btn btn-outline-secondary mt-2 w-100" @click="pasoActual = 1">Volver al paso anterior</button>
        </form>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    async validarPaso1() {
      const isValid = await this.validador.validate();
      if (isValid) {
        this.pasoActual = 2;
    ...
    async validarPaso2() {
      const isValid = await this.validadorPaso2?.validate();
      if (isValid) {
        Swal.fire({
          title: '¿Estás seguro?',
  ...
  mounted() {
    nextTick(() => {
      this.validador = new JustValidate('#formPaso1');
      this.validador
        ...
        .addField('#nacionalidad', [
          { rule: 'required', errorMessage: 'La nacionalidad es obligatoria' }
        ])
        .addField('#telefono', [
